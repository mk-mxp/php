...
#[AsCommand(
    ...
    description: 'This will automatically update tests',
)]
class UpdateTestsCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        // exercises/practice/<slug>/.meta/tests.php.twig
        // $this->exercise->doesUpdate();
